The context schema is now fully built using just a reference to a function.

The following issues from V0.3 will rollover to V0.7 as they are lower priority than the above:
